...
using Patrol = chapt4_interfSaces::srv::Patrol;
...
class TurtleControlNode: public rclcpp::Node
{
    private:
        ...
        rclcpp::Subscription<turtlesim::msg::Pose>::SharedPtr subsciber_;//订阅者的智能共享指针
    ...
    public:
        explicit TurtleControlNode(const std::string& node_name):Node(node_name)
        {
            ...
            subsciber_ = this->create_subscription<turtlesim::msg::Pose>("/turtle1/pose",10,std::bind(&TurtleControlNode::on_pose_recieved_,this,std::placeholders::_1));
        }

        void on_pose_recieved_(const turtlesim::msg::Pose::SharedPtr pose) //参数：收到的共享指针
        {
            //1.获取当前位置
...
int main(int argc, char* argv[])
{
    ...
    std::cout << "turtle_circle开始运行" <<std::endl;
    rclcpp::spin(node);
    rclcpp::shutdown();
    return 0;
}